...
public enum MasterDBBindingComparator implements Comparator<MasterDatabaseBinding> {
    ...
    public int compare(MasterDatabaseBinding mdb1, MasterDatabaseBinding mdb2) {
        ...
        if (o1Priority == null) {
            throw new IllegalStateException("Cannot find binding priority: " + mdb1.getOrigin().getValue());
        }
        if (o2Priority == null) {
            throw new IllegalStateException("Cannot find binding priority: " + mdb2.getOrigin().getValue());
        }
