...
public class UpdateMessageBindingSourceException extends Exception {

    /** */
    private static final long serialVersionUID = 801190427695923174L;

    public UpdateMessageBindingSourceException(DatabaseBindingSource databaseBindingSource) {
        super("Unrecognized source \"" + databaseBindingSource + "\"");
    }
}
