 ...
 */
public class SxpDatabaseImpl extends org.opendaylight.sxp.util.database.spi.SxpDatabase {
    ...
    @Override
    protected List<SxpDatabaseBinding> deleteBindings(NodeId nodeId, Set<IpPrefix> prefixes, BindingDatabase.BindingType bindingType) {
