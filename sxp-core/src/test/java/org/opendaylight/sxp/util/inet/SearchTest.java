...
public class SearchTest {
    ...
    public void testInstantiation() throws Exception {
        Constructor<Search> c = Search.class.getDeclaredConstructor(new Class[0]);
        c.setAccessible(true);
        Search newInstance = c.newInstance(new Object[0]);
        Assert.assertNotNull(newInstance);
    }

    @Test
    public void testGetBestLocalDeviceAddress() throws Exception {
    ...
    @Test
    public void testExpandBindings() throws Exception {
    ...
    @Test
    public void testExpandBinding() throws Exception {
        ...
        assertEquals(256, Search.expandBinding(
                new MasterDatabaseBindingBuilder().setIpPrefix(IpPrefixConv.createPrefix("2001:db8::ff00:42:8329/120"))
                        .build(), Short.MAX_VALUE).size());
    }
