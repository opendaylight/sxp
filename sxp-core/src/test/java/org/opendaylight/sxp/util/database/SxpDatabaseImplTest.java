...
public class SxpDatabaseImplTest {
    ...
    @Test public void testFilterDatabase() throws Exception {
        ...
        //DB to be removed
        assertBindings(database.filterDatabase(NodeId.getDefaultInstance("127.0.0.1"), filter),
    ...
    @Test public void testGetReplaceForBindings() throws Exception {
        ...
        assertBindings(database.getReplaceForBindings(mergeBindings()), mergeBindings());

        assertBindings(database.getReplaceForBindings(mergeBindings(getBinding("2.2.2.2/32", 200))),
        ...
        assertBindings(database.getReplaceForBindings(mergeBindings(getBinding("2.2.2.2/32", 20))),
                mergeBindings(getBinding("2.2.2.2/32", 200)));
        assertBindings(database.getReplaceForBindings(mergeBindings(getBinding("2.2.2.2/32", 254))),
                mergeBindings(getBinding("2.2.2.2/32", 200)));
        assertBindings(database.getReplaceForBindings(mergeBindings(getBinding("25.2.2.2/32", 20))),
                mergeBindings());
    }
