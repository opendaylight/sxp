...
public class ArraysUtilTest {
    ...
    public void testGetBitAddress() throws Exception {
        ...
        assertArrayEquals(new byte[] {-1, -1, -1, 127}, ArraysUtil.getBitAddress("255.255.255.254").toByteArray());
    }
    ...
    @Test
    public void testConvertBits() throws Exception {
    ...
    @Test
    public void testInt2bytesCropp() throws Exception {
    ...
    public void testReadBytes() throws Exception {
        ...
        assertArrayEquals(new byte[] {10, 4, -89, -24}, ArraysUtil.readBytes(new byte[] {10, 4, -89, -24}, 0, 4));
    ...
    @Test
    public void testReverseBitsByte() throws Exception {
