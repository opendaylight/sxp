...
public class MessageDecoderTest {
    ...
    public void testChannelActive() throws Exception {
        ...
        when(connection.isStateOn(any(ChannelHandlerContextType.class))).thenReturn(true);
        decoder.channelActive(channelHandlerContext);
        verify(connection, times(2)).addChannelHandlerContext(any(ChannelHandlerContext.class));

        when(connection.isStateOn(any(ChannelHandlerContextType.class))).thenReturn(false);
        decoder.channelActive(channelHandlerContext);
