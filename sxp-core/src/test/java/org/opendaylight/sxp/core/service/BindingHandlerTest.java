...
@RunWith(PowerMockRunner.class) @PrepareForTest({SxpNode.class}) public class BindingHandlerTest {
        ...
        private static org.opendaylight.sxp.util.database.spi.SxpDatabase databaseProvider;
        ...
        @Before public void init() throws Exception {
                ...
                databaseProvider = mock(org.opendaylight.sxp.util.database.spi.SxpDatabase.class);
