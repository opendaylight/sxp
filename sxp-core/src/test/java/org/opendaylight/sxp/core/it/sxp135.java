 ...
 * state of the codebase is **** and does not allow for consumers listen to important events.
 * <p>
...
public class sxp135 {
    ...
    public void init() throws Exception {
        SxpNodeIdentity nodeIdentity1 = createIdentity(true, "127.0.0.1", Constants.SXP_DEFAULT_PORT, Version.Version4, DELETE_HOLD_DOWN_TIMER, 3); //Listener
        this.node1 = SxpNode.createInstance(new NodeId("1.1.1.1"), nodeIdentity1);
        SxpNodeIdentity nodeIdentity2 = createIdentity(true, "127.0.0.2", Constants.SXP_DEFAULT_PORT, Version.Version4, DELETE_HOLD_DOWN_TIMER, 999); //Speaker
