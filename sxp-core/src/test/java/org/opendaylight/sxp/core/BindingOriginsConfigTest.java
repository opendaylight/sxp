...
public class BindingOriginsConfigTest {
    ...
    public void testDeleteBindingOrigin() {
        final OriginType originType = new OriginType("CLUSTER");
        Assert.assertTrue(INSTANCE.deleteBindingOrigin(originType));
        // origin type was deleted
        Assert.assertEquals(3, INSTANCE.getBindingOrigins().size());
        Assert.assertFalse(INSTANCE.containsOrigin(originType));
    }
    ...
    public void testDeleteBindingOriginDefault() {
        ...
        // origin type was not deleted
        Assert.assertEquals(4, INSTANCE.getBindingOrigins().size());
        Assert.assertTrue(INSTANCE.containsOrigin(BindingOriginsConfig.LOCAL_ORIGIN));
    }
