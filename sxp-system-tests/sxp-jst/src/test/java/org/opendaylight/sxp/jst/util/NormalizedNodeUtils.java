...
public class NormalizedNodeUtils {
    ...
    public static Optional<NormalizedNode<?, ?>> findNode(NormalizedNode<?, ?> nodeList, String nodeId) {
    ...
    public static Optional<NormalizedNode<?, ?>> findTopology(NormalizedNode<?, ?> topologyList, String topoId) {
        YangInstanceIdentifier id = YangInstanceIdentifier.builder()
