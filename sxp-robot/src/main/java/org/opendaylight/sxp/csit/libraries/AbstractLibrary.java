...
public abstract class AbstractLibrary extends AbstractClassLibrary implements AutoCloseable {
     ...
     */
    public SxpNode jrobotAddConnection(SxpNode node, Version version, ConnectionMode mode, String ip, String port,
            String password) {
    ...
    public synchronized void jrobotAddNode(String nodeId, String version, String port, String password) {
    ...
    @ArgumentNames({})
    public synchronized void jrobotStartNodes() {
    ...
    public synchronized void jrobotAddConnection(String version, String mode, String ip, String port, String password,
            String nodeId) {
        jrobotAddConnection(LibraryServer.getNode(nodeId), getVersion(version), getMode(mode), ip, port, password);
    }
    ...
    @ArgumentNames({})
    public synchronized void jrobotCleanLibrary() throws Exception {
