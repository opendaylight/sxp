...
public class ConnectionTestLibrary extends AbstractLibrary {
    ...
    @ArgumentNames({})
    public synchronized long jrobotGetConnectedPeers() {
    ...
    @ArgumentNames({})
    public synchronized double jrobotGetConnectTime() {
    ...
    public synchronized void jrobotInitiateConnecting(String peersCount) {
        close();
