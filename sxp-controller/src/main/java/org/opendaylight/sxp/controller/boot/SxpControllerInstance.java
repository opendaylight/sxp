...
import static org.opendaylight.sxp.core.BindingOriginsConfig.DEFAULT_ORIGIN_PRIORITIES;
...
public class SxpControllerInstance implements ClusterSingletonService, AutoCloseable {
    ...
    public synchronized void instantiateServiceInstance() {
        ...
        initBindingOrigins(datastoreAccess, DEFAULT_ORIGIN_PRIORITIES, LogicalDatastoreType.CONFIGURATION);
        initBindingOrigins(datastoreAccess, DEFAULT_ORIGIN_PRIORITIES, LogicalDatastoreType.OPERATIONAL);
