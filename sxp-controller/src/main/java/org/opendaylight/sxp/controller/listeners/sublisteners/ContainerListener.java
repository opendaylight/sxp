...
public abstract class ContainerListener<R extends ChildOf<? super SxpNodeIdentity>, T extends DataObject> {
    ...
    protected ContainerListener(DatastoreAccess datastoreAccess) {
    ...
    public void handleChange(DataObjectModification<R> modifiedChildContainer,
    ...
    public abstract DataObjectModification<R> getModifications(DataTreeModification<SxpNodeIdentity> treeModification);
