...
public class SxpControllerModule
    ...
    @Override public java.lang.AutoCloseable createInstance() {
        ...
        dataChangeListenerRegistrations.add(
                new PeerGroupListener(datastoreAccess, LogicalDatastoreType.OPERATIONAL).register(dataBroker));
        dataChangeListenerRegistrations.add(
                new FilterListener(datastoreAccess, LogicalDatastoreType.OPERATIONAL).register(dataBroker));
