...
public class SxpControllerModule
    ...
    @Override public java.lang.AutoCloseable createInstance() {
        ...
        SxpDataChangeListener<?>[]
                listeners =
                {new NodeIdentityListener(datastoreAccess), new ConnectionsListener(datastoreAccess),
                        new PeerGroupListener(datastoreAccess), new FilterListener(datastoreAccess)};
