...
/**
 * SxpControllerInstance represent SxpController logic consisting of multiple Datastore listeners,
 * that simulate SXP device based on provided configuration
 */
public class SxpControllerInstance implements AutoCloseable {
    ...
    /**
     * Default Constructor for {@link SxpControllerInstance}
     *
     * @param broker {@link DataBroker} used for registering listeners
     */
