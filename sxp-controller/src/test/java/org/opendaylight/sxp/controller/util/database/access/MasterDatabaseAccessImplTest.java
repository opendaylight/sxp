...
@RunWith(PowerMockRunner.class) @PrepareForTest({DatastoreAccess.class}) public class MasterDatabaseAccessImplTest {

        @Rule public ExpectedException exception = ExpectedException.none();

        private static MasterDatabaseAccessImpl databaseAccess;
        ...
        @Before public void init() throws Exception {
                ...
                PowerMockito.when(access.read(any(InstanceIdentifier.class), any(LogicalDatastoreType.class)))
                        .thenReturn(future);
                databaseAccess = new MasterDatabaseAccessImpl("Test", access, LogicalDatastoreType.OPERATIONAL);
        }

        @Test public void testDelete() throws Exception {
                MasterDatabaseBuilder database = new MasterDatabaseBuilder();
                List<Source> sources = new ArrayList<>();
                database.setSource(sources);
        ...
        @Test public void testMerge() throws Exception {
                databaseAccess.merge(new MasterDatabaseBuilder().build());
        ...
        @Test public void testPut() throws Exception {
                databaseAccess.put(new MasterDatabaseBuilder().build());
