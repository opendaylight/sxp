...
@RunWith(PowerMockRunner.class) @PrepareForTest({MasterDatabaseImpl.class, SxpNode.class, DatastoreAccess.class})
public class MasterDatastoreImplTest {
        ...
        private static List<MasterDatabaseBinding> databaseBindings = new ArrayList<>();
