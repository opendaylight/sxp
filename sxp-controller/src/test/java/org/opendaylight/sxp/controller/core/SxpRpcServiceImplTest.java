...
public class SxpRpcServiceImplTest {
    ...
    public static void setUp() {
        ...
        SxpRpcServiceImplTest.generalAnswer = invocation -> {
            LogicalDatastoreType datastoreType = invocation.getArgumentAt(0, LogicalDatastoreType.class);
            InstanceIdentifier<?> identifier = invocation.getArgumentAt(1, InstanceIdentifier.class);
    ...
    public void testAddNode() throws Exception {
        initMasterDatabaseOperations(SxpRpcServiceImplTest.generalAnswer);
        when(sxpNode.getNodeId()).thenReturn(new NodeId("0.0.0.1"));
        Configuration.register(sxpNode);
     ...
     * <p>
     * {@link ReadOnlyTransaction} and {@link WriteTransaction} are assumed to be created by {@link BindingTransactionChain}.
     * <p>
     * {@link ReadOnlyTransaction} reads data according to {@code readAnswer}
     * <p>
     * {@link WriteTransaction} is submitted successfully.
     *
     * @param dataBroker mock of {@link DataBroker}
     * @param readTransaction mock of {@link ReadOnlyTransaction}
     * @param writeTransaction mock of {@link WriteTransaction}
     * @param readAnswer {@link Answer} to be returned by {@link ReadOnlyTransaction}
