...
public class ConnectionsListenerTest {
    ...
    public void setUp() throws Exception {
        ...
        connectionsListener = new ConnectionsListener(datastoreAccess);
    }
    ...
    public void testHandleOperational_1() throws Exception {
        connectionsListener.handleOperational(getObjectModification(DataObjectModification.ModificationType.WRITE, null,
    ...
    public void testHandleOperational_2() throws Exception {
        connectionsListener.handleOperational(getObjectModification(DataObjectModification.ModificationType.WRITE,
    ...
    public void testHandleOperational_3() throws Exception {
        connectionsListener.handleOperational(getObjectModification(DataObjectModification.ModificationType.DELETE,
                getConnection("1.1.1.1", ConnectionState.Off, 56), null), getIdentifier(), sxpNode);
        verify(sxpNode).removeConnection(any(InetSocketAddress.class));
    }
    ...
    public void testHandleOperational_4() throws Exception {
        connectionsListener.handleOperational(
    ...
    public void testGetIdentifier() throws Exception {
        assertNotNull(connectionsListener.getIdentifier(new ConnectionBuilder().setTcpPort(new PortNumber(64))
                .setPeerAddress(IpAddressBuilder.getDefaultInstance("1.1.1.1"))
                .build(), getIdentifier()));

        assertTrue(connectionsListener.getIdentifier(new ConnectionBuilder().setTcpPort(new PortNumber(64))
                .setPeerAddress(IpAddressBuilder.getDefaultInstance("1.1.1.1"))
    ...
    public void testHandleChange() throws Exception {
        connectionsListener.handleChange(Collections.singletonList(getObjectModification(
    ...
    public void testGetModifications() throws Exception {
        assertNotNull(connectionsListener.getObjectModifications(null));
        assertNotNull(connectionsListener.getObjectModifications(mock(DataObjectModification.class)));
        assertNotNull(connectionsListener.getModifications(null));
        ...
        assertNotNull(connectionsListener.getModifications(dtm));
    }
